...
@Component
public class IngredientStockModelAssembler extends RepresentationModelAssemblerSupport<IngredientStock, IngredientStockModel> {
    @Autowired
    private ModelMapper modelMapper;

    public IngredientStockModelAssembler() {
